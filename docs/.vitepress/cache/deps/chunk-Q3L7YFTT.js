  ...
  return ((protoOrTarget, nameOrContext, descriptor) => {
    ...
    if (cache) {
      const { get, set } = typeof nameOrContext === "object" ? protoOrTarget : descriptor ?? (() => {
        const key = DEV_MODE3 ? /* @__PURE__ */ Symbol(`${String(nameOrContext)} (@query() cache)`) : /* @__PURE__ */ Symbol();
        return {
          get() {
            return this[key];
          },
...
var ChildPart = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE4 && this.options?.host === value) {
...
//# sourceMappingURL=chunk-Q3L7YFTT.js.map
